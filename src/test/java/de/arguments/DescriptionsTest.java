...
public class DescriptionsTest {
	...
	public void checkOptionalBooleanToString() {
		...
		String actual = (new OptionalBoolean("b", true,
				"This is a optional Boolean")).toString();
	...
	public void checkOptionalDoubleToString() {
		...
		String actual = (new OptionalDouble("d", 1.234,
				"This is a optional Double")).toString();
		assertEquals(expected, actual);
	}
	...
	public void checkOptionalIntegerToString() {
		...
		String actual = (new OptionalInteger("i", 123,
				"This is a optional Integer")).toString();
		assertEquals(expected, actual);
	}

	@Test
	public void checkOptionalStringToString() {
		String expected = "-s String : This is a optional String (Default = \"default\")";
		String actual = (new OptionalString("s", "default",
	...
	public void checkRequiredBooleanToString() {
		...
		String actual = (new RequiredBoolean("b", "This is a required Boolean"))
				.toString();
		assertEquals(expected, actual);
	}
	...
	public void checkRequiredCharToStringNoDiscr() {
		...
		String actual = (new RequiredChar("i"))
				.toString();
		assertEquals(expected, actual);
	}
