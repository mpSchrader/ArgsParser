...
public class OptionalCharTest {
	...
	@Test
	public void getTestSmallConstructor() {
		OptionalChar optional = new OptionalChar('i', 'a');

		assertEquals("", optional.getDescription());
		assertEquals('i', optional.getId());
		assertEquals(new Character('a'), optional.getDefault());
	}
